...
//	}
	...
	@GetMapping("/alldoctorsbyhospital/{id}")
	public List<Doctor> allDoctorsByHospital(@PathVariable int id){
			Hospital h = hservice.getOneById(id);
		return dservice.allDoctorsByHospital(h);
	}
