...
//	}
	...
	public List<Hospital> allHospitalsByArea(@PathVariable int id){
		Area a = aservice.getAreaById(id);
		return hservice.allHospitalsByArea(a);
	}
	
	@GetMapping("/hospitalspeciality")
	...
	public List<Hospital> allHospitalsAreaAndSpeciality(@PathVariable int areaId, @PathVariable String spec){
		Area a = aservice.getAreaById(areaId);
		return hservice.allHospitalsAreaAndSpeciality(a,spec);
	}
	
	@GetMapping("/getonehospital/{id}")
	public Optional<Hospital> getOneHospital(@PathVariable int id) {
		return hservice.getOneHospital(id);
	}
	
	@PostMapping("/savehospital")
	public Hospital saveHospital(@RequestBody HospitalRegistration dr) {
		System.out.println("*******"+dr);
		Login l = new Login(dr.getUserName(),dr.getPassword(),"Hospital");
	...
	public Hospital updateHospital(@RequestBody Hospital dr) {
		try {
