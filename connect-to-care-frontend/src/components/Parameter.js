  ...
  const validateEmail = (e) => {
    ...
    if (emailRegex.test(email) === true) {
      ...
      setError({
        ...Error,
        user_name_error:
          "Email format should be 'abc@gmail.com' and it can include (A-Z a-z 0-9 . _ -)",
      });
  ...
  const validatePassword = (e) => {
    ...
    if (passRegex.test(pass) === true) {
      ...
      setError({
        ...Error,
        password_error:
          "Password must be alphanumeric and should contains at least a special character with min length 8 and max length 16",
      });
  ...
  const validateMobileNumber = (e) => {
    ...
    if (mnRegex.test(mobileNumber) === true) {
      ...
      setError({
        ...Error,
        mobile_number_error:
          "Mobile Number should be 10 digits without +91 or 0",
      });
      ...
      <div className="container" style={{ marginBottom: "120px" }}>
        <div className="row my-4">
          <div className="card col-md-6 offset-md-3 offset-md-1">
            <h2 className="text-center">Your Parameters </h2>
