...
function PatientRegistration(){
    ...
    const validateAadharNumber=(e)=>{
        ...
        if(mnRegex.test(mobileNumber) === true){
            ...
            setError({...Error,mobile_number_error:"Aadhar Number should be 12 digits"});
            setFlag({...flag,mobileNumber:false});
    ...
    <div className = "row">
        ...
        <form method="POST">
            ...
            <div style={{ marginTop: '10px' }} className = "form-group">
                <label><b>  User Aadhar_Number: </b></label>
                <input type="text" placeholder="User aadhar_number" name="aadhar_number" className="form-control" 
