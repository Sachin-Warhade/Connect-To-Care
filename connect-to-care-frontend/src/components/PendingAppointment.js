  ...
  return (
    <>
      ...
      <div className="container my-4" style={{ marginBottom: "50px" }}>
        ...
        <br></br>{" "}
        <div>
          <button className="btn btn-primary" onClick={currentappointments}>
            Pending Appointment
          </button>
          <h3>Pending Appointment List</h3>
              ...
              {appointments.map((v) => {
                return (
                  <tr>
                    ...
                    <td
                      style={{
                        display: v.status === "cancelled" ? "block" : "none",
                      }}
                    >
                      {v.status}
                    </td>
                    <td
                      style={{
                        display: v.status === "scheduled" ? "block" : "none",
                      }}
                    >
                      success
                    </td>
