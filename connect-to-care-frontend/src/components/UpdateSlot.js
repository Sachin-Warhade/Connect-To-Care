...
function UpdateSlot() {
    ...
    useEffect(() => {
        ...
        setTimetable({ slotId: tt.slotId, doctor_id: tt.doctor_id, weekday: tt.weekday, startTime: tt.startTime, endTime: tt.endTime, slotDuration: tt.slotDuration, breakTime: tt.breakTime })
